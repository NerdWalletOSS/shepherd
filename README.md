...
hooks:
  ...
  issue_message: 'This is the test message'
  issue_labels: ['bug', 'enhancements']
...
- `issue`: Creates/Updates/Close issue on the repo with `title`, `issue_message` , `issues_labels` , `state` and `state_reason`.
